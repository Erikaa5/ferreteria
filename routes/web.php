...
Route::post('/proveedores/store', function () {
    ...
    $validator = Validator::make(request()->all(), [
        ...
        'cuit' => 'required|string|numeric|digits:11|unique:proveedores,cuit',
...
Route::post('/clientes/store', function ()
{
   ...
   $nombre = request()->nombre;
    ...
    $validator = Validator::make(request()->all(), [
        ...
        'cuit' => 'required|string|numeric|digits:11|unique:clientes,cuit',
...
Route::post('/marcas/store', function ()
{
    ...
    $nombre = request()->nombre;
    $validator = Validator::make(request()->all(), [
        'nombre' => 'required|string|max:250|unique:marcas,marcas_descripcion'
    ]);
